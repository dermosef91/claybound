...
// dream's models are the garden's watching flower, the orchard's planets,
// saucer bowls and canopy sculpture and the parade's hat, so the hero, the
// clay surface and those are all it needs.
