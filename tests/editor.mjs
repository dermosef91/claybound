...
}
{
 ...
 assert.equal(LEVELS[1].layoutVersion,8);assert(!LEVELS[1].custom);assert(!draft.boss,'old forest imports keep their original finish');
...
}
{
 ...
 assert.equal(LEVELS[2].layoutVersion,8);assert(!LEVELS[2].custom);
