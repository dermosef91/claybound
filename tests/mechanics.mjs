...
check('air stomp breaks cracked floors',()=>{const g=game(1);const s=g.level.platforms.find(s=>s.id==='crack1');Object.assign(g.player,{x:s.x+2,y:s.y+1.5,groundId:null,coyote:0});step(g,.18,{stompPressed:true});assert(s.broken);assert(g.player.y<s.y);});
