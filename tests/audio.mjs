...
for(const [type,buffer,gain]of [['coin',interactionSound.coinBuffer,.05],['checkpoint',interactionSound.checkpointBuffer,.25],['complete',interactionSound.completeBuffer,.5]]){
...
assert.equal(variedCoin.output.gain.value,.05);assert.equal(variedCoin.playbackRate.value,.679);assert.notEqual(variedCoin.playbackRate.value,firstCoin.playbackRate.value,'successive coin pickups vary pitch');
