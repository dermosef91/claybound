...
export const THEMES={
  citadel:{terrain:0x315e96,terrain2:0x2d588c,top:0xd8592e,bark:0x244973,barkLight:0xd96b3a,foliage:0x4775a2,leafLight:0x638eb8,vine:0x3e6491,back:0x587fa8,back2:0x416e9d,accent:0xe56a35,water:0x507d9f,rope:0xdfbc86,dust:0xe8cca0,skyLight:0xd3e3f0,groundLight:0x23466b,sun:0xffe3bd,sunPower:3.25,ambient:2.1,fill:0xb8d1e9,fillPower:.5},
  desert:{terrain:0xd56a37,terrain2:0xc85c31,top:0xed9551,bark:0x8e4e27,barkLight:0xbe793d,foliage:0x408559,leafLight:0x5b9b62,vine:0x487c47,back:0xe89c69,back2:0xd98550,accent:0xffd568,water:0x7daaae,rope:0xe3b56f,dust:0xf1c798,skyLight:0xd3e5fa,groundLight:0xa35b35,sun:0xffdfb6,sunPower:3.3,ambient:2.1,fill:0xc7def7,fillPower:.7,cameraElevation:1.6},
...
export function buildTerrain(w,s,g){
  ...
  if(w.biome==='forest'){
    ...
    caveCrystals(w,g,width-1.2,.07,-1.2,.72);
    if(s.id==='start'||s.checkpoint||s.goal)torch(w,g,s.id==='start'?8.1:width*.4,.05);
    if(width>8)caveMushrooms(w,g,2,.03,-1.15,.72);
