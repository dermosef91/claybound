...
export const THEMES={
  ...
  // The canyon's light is a hotter, warmer sun under less sky: the reference
  // cliffs are side-lit, their brick tops catching the key and their joints
  // and undersides falling into shade, where an even 2.1 of hemisphere fill
  // had rendered every face the same orange.
  desert:{terrain:CLAY_PALETTE.orange,terrain2:CLAY_PALETTE.orangeDark,top:CLAY_PALETTE.orangeLight,bark:0x8e4e27,barkLight:0xbe793d,foliage:0x408559,leafLight:0x5b9b62,vine:0x487c47,back:CLAY_PALETTE.orangeLight,back2:CLAY_PALETTE.orange,accent:0xffd568,water:0x7daaae,rope:0xe3b56f,dust:0xf1c798,skyLight:0xd3e5fa,groundLight:0xa35b35,sun:0xffd9a6,sunPower:3.7,ambient:1.7,fill:0xc7def7,fillPower:.5,cameraElevation:1.6,crumble:'clay'},
...
export function applyEnvironment(w,L){
  ...
  // The cave's authored sky is a dark navy that read as a wall behind the
...
export function buildTerrain(w,s,g){
  ...
  if(w.biome==='dream'){buildDreamTerrain(w,s,g);return;}
...
export function buildBackdrop(w,L){
  ...
  else if(w.biome==='dream')buildDreamBackdrop(w,L);
