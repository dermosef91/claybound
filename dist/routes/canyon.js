...
export default chapter({
  ...
  platforms:[
    ...
    p('arch-bridge-left',175.9,1.1,13.44),p('arch-drop',176.85,6.3,13.5,'bridge'),p('arch-bridge-right',183,1.15,13.44),
    p('last-rest',184,7,12.6,'stone',{checkpoint:187,landmark:'oasis',rest:true}),p('last-well',191,6,12.6,'stone',{landmark:'windmill'}),
  ...
  hints:[{x:0,end:9,title:'Find your stride',text:'Move with A / D or arrows. Hold jump to leap farther.'},{x:43,end:51,title:'Wake the windwell',text:'Step on the cream valve. The rising ribbons lift your jumps.'},{x:91,end:100,title:'Light on the sand',text:'Pale ledges sink after landing. Keep your rhythm across the gaps.'}],
