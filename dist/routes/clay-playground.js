...
L.shaping=[
  {id:'lift',name:'Lower the lift',verb:'Press down',gesture:'down',parts:['soft-support'],lift:'kneaded-lift',liftFrom:5.4,liftTo:1.4,x:3,end:25,spawn:{x:6,y:0,groundId:'workshop-start'},hint:'Drag the orange support down. Shortening it lowers the hanging lift. Or hold E / KNEAD; a stomp also presses it.'},
  {id:'ramp',name:'Stretch a ramp',verb:'Pull right',gesture:'right',parts:['soft-ramp'],x:25,end:44,spawn:{x:28,y:1.1,groundId:'ramp-dock'},hint:'Drag the orange clay to the right to stretch a walkable ramp. Or hold E / KNEAD.'},
  {id:'landing',name:'Widen the landing',verb:'Pull outward',gesture:'out',parts:['soft-landing'],x:44,end:62,spawn:{x:44,y:4.4,groundId:'ramp-roof'},hint:'Pull either edge of the narrow landing outward. The cap spreads into a safe place to jump. Or hold E / KNEAD.'},
  {id:'stairs',name:'Wall into stairs',verb:'Pull right',gesture:'right',parts:['soft-stair-0','soft-stair-1','soft-stair-2'],x:62,end:80,spawn:{x:64,y:3.1,groundId:'landing-roof'},hint:'Pull the orange wall to the right to knead out three steps. Jump up the new ledges. Or hold E / KNEAD.'},
  {id:'bridge',name:'Press a bridge',verb:'Press down',gesture:'down',parts:['soft-bridge'],x:80,end:103,spawn:{x:81,y:8.4,groundId:'stair-roof'},hint:'Press the tall orange clay down to spread it across the gap. Drag down, hold E / KNEAD, or stomp it.'}
];
L.hints.unshift(...L.shaping.map(s=>({x:s.x,end:s.end-.001,title:s.name,text:s.hint})));
