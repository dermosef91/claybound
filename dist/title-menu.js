...
export function settingsMarkup(soundEnabled,fullscreenActive,{music=.55,effects=1,rumble=true,stopMotion=true,stopMotionTuning,stopMotionTuningUnlocked=false,analytics=true,characters=[],character='',charactersUnlocked=false}={}){
