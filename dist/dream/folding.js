// Section 2 — The Folding Path (visual module, EMPTY).
// Decks that fold up into walls (the fold primitive) on a hinge; the author builds the hinge dressing, the paper-fold backdrop and the striped path.
//
