"""Resize embedded windmill textures for mobile without changing geometry/UVs.

Usage: python scripts/prepare-windmill-assets.py UPLOAD_DIRECTORY
...
assets={
 'windmill-tower.glb':'Meshy_AI_Autumn_Windmill塔_0909180755_texture.glb',
 'windmill-sails.glb':'Meshy_AI_Clay_Windmill_Sails_0909180810_texture.glb'
}
...
(root/'dist/assets/windmill-assets.json').write_text(json.dumps(manifest,indent=2)+'\n')
