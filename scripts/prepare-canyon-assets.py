"""Resize embedded canyon textures for mobile without changing geometry/UVs.

Usage: python scripts/prepare-canyon-assets.py UPLOAD_DIRECTORY
...
assets={
 'canyon-arch.glb':'Meshy_AI_Clay_Canyon_Arch_0906011758_texture.glb',
 'canyon-summit.glb':'Meshy_AI_Clay_Summit_Flag_0906011749_texture.glb',
 'cactus.glb':'Meshy_AI_Clay_Cactus_0906011738_texture.glb'
}
...
(root/'dist/assets/canyon-assets.json').write_text(json.dumps(manifest,indent=2)+'\n')
