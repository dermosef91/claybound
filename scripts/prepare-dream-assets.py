...
# the eyeball's is a 4096² map — over half its 16.5 MB — painting a roughness
# clayMaterials overrides anyway).
matte={'dream-hat.glb','dream-arch.glb','dream-eyeball.glb'}
